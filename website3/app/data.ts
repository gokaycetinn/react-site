...
export const copy = {
  tr: {
    ...
    projectsStat: "Seçili Portföy Projesi",
    education: "Eğitim",
  ...
  en: {
    ...
    projectsStat: "Selected Portfolio Projects",
    education: "Education",
...
export const experiences = [
  ...
  },
  {
    ...
    summary: {
      tr: "Google Türkiye destekli yapay zekâ programındaki 1.500 katılımcı arasına seçildim.",
      en: "Selected as one of 1,500 participants in a Google Türkiye-supported AI program.",
    },
    bullets: {
      tr: [
        "Hackathon ve ekip projelerinde yapay zekâ destekli uygulamalar ve pratik çözümler geliştirdim.",
        "Takım çalışması, problem çözme ve hızlı prototipleme becerilerimi gerçek proje senaryolarında geliştirdim.",
      ],
      en: [
        "Developed AI-driven applications and practical solutions through hackathons and team-based projects.",
        "Improved problem-solving, collaboration, and rapid prototyping skills through real project scenarios.",
      ],
    },
  ...
  },
  {
    ...
    summary: {
      tr: "Yapay zekâ tabanlı mobil uygulamaların geliştirilmesine katkı sağladım.",
      en: "Contributed to the development of AI-based mobile applications.",
    },
    bullets: {
      tr: [
        "Smart Beauty mobil uygulaması için yeni özellikler geliştirdim ve mevcut özellikleri entegre ettim.",
        "Mobil uygulama akışlarının uygulanması ve iyileştirilmesi üzerinde çalıştım.",
      ],
      en: [
        "Developed and integrated features for the Smart Beauty mobile application.",
        "Worked on implementing and improving mobile application flows.",
      ],
    },
  ...
  },
  {
    ...
    role: { tr: "Yazılım Geliştirme Stajyeri", en: "Software Development Intern" },
    date: { tr: "Eylül 2024 - Ekim 2024 (2 ay)", en: "Sep 2024 - Oct 2024 (2 months)" },
    logo: `${basePath}/logos/e4e.webp`,
    summary: {
      tr: "Kullanıcı odaklı tasarım ve yapılandırılmış veri yönetimi içeren bir masaüstü uygulaması geliştirdim.",
      en: "Developed a desktop application with user-focused design and structured data management.",
    },
    bullets: {
      tr: [
        "Digital Diary masaüstü uygulamasının arayüzünü ve veri yönetimi akışını geliştirdim.",
      ],
      en: [
        "Developed the interface and structured data management flow of the Digital Diary desktop application.",
      ],
    },
